...
{
    public class ProjectObservedPercentCompletedCreateTest : XmlObjectTestHelper
    {
        [Fact]
...
<function controlid=""unittest"">
    <create>
        <OBSPCTCOMPLETED>
            ...
            ProjectObservedPercentCompletedCreate record = new ProjectObservedPercentCompletedCreate("unittest")
            {
                ProjectRecordNo = 1,
