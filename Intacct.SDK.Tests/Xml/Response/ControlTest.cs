...
<response>
      <control>
            ...
            var ex = Record.Exception(() => new OnlineResponse(stream));
            Assert.IsType<IntacctException>(ex);
            Assert.Equal("Control block is missing senderid element", ex.Message);
        }
...
<response>
      <control>
            ...
            var ex = Record.Exception(() => new OnlineResponse(stream));
            Assert.IsType<IntacctException>(ex);
            Assert.Equal("Control block is missing controlid element", ex.Message);
        }
...
<response>
      <control>
            ...
            var ex = Record.Exception(() => new OnlineResponse(stream));
            Assert.IsType<IntacctException>(ex);
            Assert.Equal("Control block is missing uniqueid element", ex.Message);
        }
...
<response>
      <control>
            ...
            var ex = Record.Exception(() => new OnlineResponse(stream));
            Assert.IsType<IntacctException>(ex);
            Assert.Equal("Control block is missing dtdversion element", ex.Message);
        }
    }
}