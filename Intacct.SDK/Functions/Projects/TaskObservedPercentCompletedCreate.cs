...
{
    public class TaskObservedPercentCompletedCreate : AbstractObservedPercentCompleted
    {
        
        public int TaskRecordNo;
        
        public TaskObservedPercentCompletedCreate(string controlId = null) : base(controlId)
        {
        }
        ...
        public override void WriteXml(ref IaXmlWriter xml)
        {
            ...
            xml.WriteElement("TYPE", "Task", true);
            xml.WriteElement("TASKKEY", TaskRecordNo, true);
