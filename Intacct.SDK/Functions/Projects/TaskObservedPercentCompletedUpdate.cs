...
{
    public class TaskObservedPercentCompletedUpdate : AbstractObservedPercentCompleted
    {

        public int RecordNo;
        
        public TaskObservedPercentCompletedUpdate(string controlId = null) : base(controlId)
        {
        }
