...
{
    public class ProjectObservedPercentCompletedCreate : AbstractObservedPercentCompleted
    {
        
        public int ProjectRecordNo;
        
        public ProjectObservedPercentCompletedCreate(string controlId = null) : base(controlId)
        {
        }
