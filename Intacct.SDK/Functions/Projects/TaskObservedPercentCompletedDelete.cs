...
{
    public class TaskObservedPercentCompletedDelete : AbstractObservedPercentCompleted
    {
        
        public int RecordNo;
        
        public TaskObservedPercentCompletedDelete(string controlId = null) : base(controlId)
        {
        }
