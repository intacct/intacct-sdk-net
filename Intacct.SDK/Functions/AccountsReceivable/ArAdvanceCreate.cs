...
namespace Intacct.SDK.Functions.AccountsReceivable
{
    ...
    public class ArAdvanceCreate : AbstractArAdvance
    {
        public ArAdvanceCreate(string controlId = null) : base(controlId)
        {
        }
        ...
        public override void WriteXml(ref IaXmlWriter xml)
        {
            ...
            xml.WriteElement("RECEIPTDATE", ReceiptDate, IaXmlWriter.IntacctDateFormat, true);
